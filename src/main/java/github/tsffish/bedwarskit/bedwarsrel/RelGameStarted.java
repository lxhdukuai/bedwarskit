...
public class RelGameStarted implements Listener {
    ...
    public static boolean customScoreboard = ConfigHandler.customScoreboard;
    public static String scoreboardTitle = ConfigHandler.scoreboardTitle;
    public static String rushWorld = ConfigHandler.rushWorld;
    public static String rushWorld2v2 = ConfigHandler.rushWorld2v2;
    public static String rushWorld4v4 = ConfigHandler.rushWorld4v4;
    public static boolean startKitCompass = ConfigHandler.startKitCompass;
    public static String meanTeamBedYes = ConfigHandler.meanTeamBedYes;
    public static String meanTeamBedNo = ConfigHandler.meanTeamBedNo;
    public static String meanTeamNone = ConfigHandler.meanTeamNone;
    public static String serverIp = ConfigHandler.serverIp;
    public static String RedTeamName = ConfigHandler.relRedTeamName;
    public static String BlueTeamName = ConfigHandler.relBlueTeamName;
    public static String GreenTeamName = ConfigHandler.relGreenTeamName;
    public static String YellowTeamName = ConfigHandler.relYellowTeamName;
    public static String AquaTeamName = ConfigHandler.relAquaTeamName;
    public static String GrayTeamName = ConfigHandler.relGrayTeamName;
    public static String PinkTeamName = ConfigHandler.relPinkTeamName;
    public static String WhiteTeamName = ConfigHandler.relWhiteTeamName;
    public static String meanYou = ConfigHandler.meanYou;
    public static String meanNotYou = ConfigHandler.meanNotYou;
